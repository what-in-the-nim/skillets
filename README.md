...
- [`quick-refactor`](skills/quick-refactor/SKILL.md) — Sol proposes three choices; the user selects before detailed redesign. Python generates HTML with content-selected visualizations.
