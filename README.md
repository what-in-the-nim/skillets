...
These are the canonical package names for the coding-principle, lifecycle-design, test-principle, pytest, and Gitea PR-review skills.
...
```sh
npx skills add what-in-the-nim/skillets -g --agent codex --skill code-principle --skill lifecycle-design --skill testing-principle --skill pytest-skill --skill review-pr --yes
```
